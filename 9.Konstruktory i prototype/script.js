...
// Zadanie 2:
/**
 * Calculator. Create new instance with numbers and make calculations on them.
 * Every calculation on particular instance will be saved and you can see calc's history. 
 * @param {Array<numbers>} numbers   Pass array of numbers
 */
class Calc {
    constructor(numbers) {
